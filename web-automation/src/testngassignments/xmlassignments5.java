...
public class xmlassignments5 {
    ...
    private static void modifycustomer() {
		try
		{
			...
			Thread.sleep(3000);
			oBrowser.findElement(By.xpath("/html/body/div[12]/div[2]/div[2]/div[2]/div[1]/div[3]/div[2]/div/div[1]/textarea")).sendKeys("customer modification");
			//oBowser.findElement(By.xpath("//div[text()='Archived']")).click();
			Thread.sleep(5000);
			oBrowser.findElement(By.xpath("/html/body/div[12]/div[1]/div[2]/div[2]/div/div[2]/div/div[1]/div[2]/div[2]/div[4]")).click();
			Thread.sleep(3000);
			WebElement oEle=oBrowser.findElement(By.xpath("//div[text()='Description']"));
			Thread.sleep(3000);
			oEle.isDisplayed();
		  Thread.sleep(3000);
