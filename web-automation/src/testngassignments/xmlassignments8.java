...
public class xmlassignments8 {
    ...
    private static void createtask() {
		...
		{
			String expected,actual;
			expected="Do Assignments strictly";
			...
			Thread.sleep(2000);
			WebElement task=oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[1]/div[2]/div[1]/table[1]/tbody/tr/td[2]/div/div[2]"));
			actual=task.getText();
			Assert.assertEquals(expected, actual);
			Thread.sleep(3000);
		}catch(Exception e)
	...
	private static void deletetask() {
		...
		Thread.sleep(3000);
		WebElement task=oBrowser.findElement(By.xpath("//p[text()='There are no tasks']"));
		actual=task.getText();
  ...
  /*   @Test(priority = 9)
    private static void modifyproject() {
		try
		{
			...
			//Thread.sleep(2000);
			WebElement ee=oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[2]/div[1]/div[1]/div[2]/div[2]/div/div[1]/textarea"));
