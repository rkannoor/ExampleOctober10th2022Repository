...
public class eight {
	...
	private static void createtask() {
		...
		{
			opage.clickonaddnewTASK().click();
			Thread.sleep(3000);
			opage.CLICKONnewTASKbutton().click();
			Thread.sleep(3000);
			opage.CLICKonENTERtaskNAME().sendKeys("pageobjectmodelassignment");
			Thread.sleep(3000);
			opage.CLICKonCREATEtask().click();
			Thread.sleep(3000);
	...
	private static void deletetask() {
		...
		{
			opage.CLICKonTASKname().click();
			Thread.sleep(3000);
			opage.clickONtaskACTIONS().click();
			Thread.sleep(3000);
			opage.CLICKONtaskDELETEbutton().click();
			Thread.sleep(3000);
			opage.clickonTASKdeletePERMANENTLY().click();
			Thread.sleep(300);
